                      ...
                        <input class="form-check-input" type="radio" id="Admin" name="pilotORstaff" value="Admin" checked>
                        ...
                        <div class="center-block" style="padding-left:40%;height: 300%;" >
                            ...
                            <div class="center-block" style="height: 300%;">
                                <input class="center-block"  type="submit" name="save" value="Submit" class="col-sm-2 col-form-label" style="background-color: rgb(8, 8, 251);color: rgb(254, 254, 254);border-color:rgb(8, 8, 251) ; height: 200%;">
